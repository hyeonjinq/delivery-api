...
INSERT INTO `categories` VALUES
                             (1,'치킨','http://localhost:8080/images/categories/chicken-leg.png',0,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(2,'일식','http://localhost:8080/images/categories/ramen.png',1,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(3,'돈까스','http://localhost:8080/images/categories/schnitzel.png',2,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(4,'구이','http://localhost:8080/images/categories/meat.png',3,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(5,'중식','http://localhost:8080/images/categories/noodle.png',4,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(6,'도시락','http://localhost:8080/images/categories/bento.png',5,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(7,'족발/보쌈','http://localhost:8080/images/categories/bossam.png',6,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(8,'버거','http://localhost:8080/images/categories/burger.png',7,0,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(9,'피자','http://localhost:8080/images/categories/pizza.png',8,1,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin')
                              ,(10,'분식','http://localhost:8080/images/categories/tteokbokki.png',9,1,'2023-10-14 21:34:16','2023-10-14 21:34:16','delivery-admin','delivery-admin');
...
--
INSERT INTO `category_store_mappings` VALUES
                                          (1,1,1,_binary '\0','2023-10-28 18:26:49','2023-10-28 18:26:49','category-manager','category-manager')
                                           ,(2,1,2,_binary '\0','2023-10-28 18:26:51','2023-10-28 18:26:51','category-manager','category-manager');
...
INSERT INTO `customers` VALUES
                            (3,'마징가','ultrakain@gmail.com','$2a$10$10h6X.mgkqQXRChbLw2EuOAN1vWpzWSF/MjiT2p1f3RjTkSQgm9zq','010-2222-3334','경기도 남양주시 다산동 중흥아파트 1002-212','ACTIVE','CUSTOMER',_binary '\0','2023-11-08 12:24:40','2023-11-08 12:24:40','delivery-api','delivery-api')
                             ,(4,'소닉','test@test.com','$2a$10$OOV2O7gQcGKFCgiZR7bL9.VuQkPq854h89Bjnj3W/9Xtf8OzjWPPu','010-1111-3333','경기도 남양주시 다산동','ACTIVE','CUSTOMER',_binary '\0','2023-12-04 11:40:37','2023-12-04 11:40:37','delivery-api','delivery-api');
...
INSERT INTO `menus` VALUES
                        (1,1,'크리스피한 맛의 치킨','http://localhost:8080/images/menu/menu-2.png',30000.00,'READY','먹고 또 먹어도 질리지 않는 맛',_binary '\0','2023-11-18 01:52:24','2023-11-18 01:52:24','${server.role-name','${server.role-name')
                         ,(2,3,'엄청난 피자','http://localhost:8080/images/menu/menu-1.png',40000.00,'SALE','엄청나게 크고 맛있는 피자입니다.',_binary '\0','2023-10-22 23:14:13','2023-10-22 23:14:13','admin','admin')
                         ,(3,1,'불맛나는 치킨','http://localhost:8080/images/menu/menu-3.png',15000.00,'SALE','화끈한 향을 즐길 수 있는 치킨',_binary '\0','2023-10-29 11:09:19','2023-10-29 11:09:19','admin','admin')
                         ,(4,1,'바삭한 치킨','http://localhost:8080/images/menu/menu-4.png',18000.00,'SALE','입안에 가득 바삭함을 느끼는 치킨',_binary '\0','2023-10-29 11:09:19','2023-10-29 11:09:19','admin','admin')
                         ,(5,1,'모듬 치킨','http://localhost:8080/images/menu/menu-5.png',21000.00,'SALE','훈제, 만두, 다양한 디쉬를 즐길 수 있는 치킨',_binary '\0','2023-10-29 11:09:19','2023-10-29 11:09:19','admin','admin')
                         ,(25,1,'(신규) 바삭한 치킨과 감자','http://localhost:8080/images/menu/menu-2.png',15000.00,'READY','정말 끝내줍니다.',_binary '\0','2023-11-18 02:24:48','2023-11-18 02:24:48','${server.role-name','${server.role-name')
                         ,(26,1,'(신규) 촉촉한 치킨과 감자','http://localhost:8080/images/menu/menu-2.png',20000.00,'READY','한번 먹어보면 멈출 수 없다',_binary '\0','2023-11-18 02:24:48','2023-11-18 02:24:48','${server.role-name','${server.role-name')
                         ,(27,1,'(신규) 쫄깃한 치킨과 콘샐러드','http://localhost:8080/images/menu/menu-2.png',30000.00,'READY','먹고 또 먹어도 질리지 않는 맛',_binary '\0','2023-11-18 02:24:48','2023-11-18 02:24:48','${server.role-name','${server.role-name');
...
INSERT INTO `refresh_tokens` VALUES
                                 (14,'ultrakain@gmail.com','eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1bHRyYWthaW5AZ21haWwuY29tIiwiaWF0IjoxNjk5NzY5NTE4LCJleHAiOjE2OTk4NTU5MTh9.caPZFYjL8BLsuo3IKvun7YLhcwHN1uz9_3JdX088XNU')
                                  ,(16,'test@test.com','eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0ZXN0QHRlc3QuY29tIiwiaWF0IjoxNzAyMjE3MDE0LCJleHAiOjE3MDIzMDM0MTR9.h64SjPizM36At5uOT783twlZGkCn12T95oQI1hTqwrM');
...
INSERT INTO `stores` VALUES
                         (1,'store1@fc.com','1111199999','아트한 치킨집','01022223333','서울특별시 송파구 잠실동','1234','1111-22-3333','배달은행','20분 ~ 30분','http://localhost:8080/images/store/store-1.png','동네에서 맛집으로 소문난 치킨집, 별점 5점',3000.00,5,8000.00,'SALE','0','2023-10-14 18:28:43','2023-10-14 18:28:43','onboarding','onboarding')
                          ,(2,'store2@home.com','2222233333','달콤한 족발집','01011112222','서울특별시 삼성역 부근','1234','2222-33-4444','궁민은행','10분 ~ 15분','http://localhost:8080/images/store/store-2.png','정말 엄청 달콤하고 쫀득한 족발집',2500.00,5,8000.00,'SALE','0','2023-10-28 22:18:42','2023-10-28 22:18:42','onboarding','onboarding')
                          ,(3,'store3@food.com','333344445','빅 피자','01033334444','서울특별시 강남구 강남역','1234','3333-44-5555','번쩍은행','30분 ~ 40분','http://localhost:8080/images/store/store-3.png','엄청난 사이즈의 피자, 국내 최대의 피자',2000.00,5,8000.00,'SALE','0','2023-10-29 10:47:30','2023-10-29 10:47:30','onboarding','onboarding')
                          ,(4,'store4@rank.com','4444555566','한번에 2마리 치킨','01044445555','서울특별시 강남구 선릉역','1234','4444-55-6666','달콤은행','30분 ~ 40분','http://localhost:8080/images/store/store-4.png','묻지도 따지지 않고 한번에 2마리 치킨',2500.00,3,8000.00,'SALE','0','2023-10-29 10:47:30','2023-10-29 10:47:30','onboarding','onboarding')
                          ,(5,'store5@cup.co.kr','2222333344','무조건 벤티 커피','01012341234','경기도 남양주시 호평동','1234','1111-12-1234','배달은행','30분 ~ 40분','http://localhost:8080/images/store/store-5.png','큰 사이즈의 커피를 기본으로 드립니다',2000.00,5,8000.00,'SALE','0','2023-10-29 10:49:28','2023-10-29 10:49:28','onboarding','onboarding')
                          ,(6,'store6@pork.com','111122223333','불맛 구이','010223344556','서울특별시 송파구 잠실동','1234','6666-22-3333','넘버원은행','30분 ~ 40분','http://localhost:8080/images/store/store-6.png','불맛이 살아있는 돼지고기 구이 전문점',1500.00,5,8000.00,'SALE','0','2023-10-29 10:57:59','2023-10-29 10:57:59','onboarding','onboarding');
